...
- 当前分支为 `main`（`electron_design` 已合并），可见页签为仓库、监视器、任务管理器、编辑器；浏览器工作台前端入口隐藏。
...
- 当前版本：npm `1.0.0-7201`、PE `1.0.0.7201`、产品名 `Catnip Forge`。

## 历史目标

本节记录任务管理器最初落地时的目标；当前可执行文件为 `win-unpacked/Catnip Forge.exe`，当前实现以上方 2026-07-20/21 基线为准。
